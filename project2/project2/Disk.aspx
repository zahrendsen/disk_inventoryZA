            ...
            <tr style="">
                ...
                <td>
                    <asp:TextBox ID="status_idTextBox" runat="server" Text='<%# Bind("status_id") %>' ValidationGroup="Edit"/>
                     <asp:RequiredFieldValidator CssClass="text-danger" ID="RequiredFieldValidator3" runat="server" ErrorMessage="<br />Status is Required" 
                        ControlToValidate="status_idTextBox" Display="Dynamic" ValidationGroup="Edit"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ControlToValidate="status_idTextBox" ID="RangeValidator3" runat="server" ErrorMessage="<br />Status must be 1 or 2" Type="Integer" ValidationGroup="Edit"
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator CssClass="text-danger" ID="RequiredFieldValidator4" runat="server" ErrorMessage="<br />Type is Required" 
                        ControlToValidate="disk_type_idTextBox" Display="Dynamic" ValidationGroup="Edit"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ControlToValidate="disk_type_idTextBox" ID="RangeValidator4" runat="server" ErrorMessage="<br />Type must be 1 or 2" Type="Integer" ValidationGroup="Edit"
                           CssClass="text-warning" Display="dynamic" MaximumValue="2" MinimumValue="1"></asp:RangeValidator>
                </td>
                <td>
                    <asp:TextBox ID="genre_idTextBox" runat="server" Text='<%# Bind("genre_id") %>' ValidationGroup="Edit"/>
                    <asp:RequiredFieldValidator CssClass="text-warning" ID="RequiredFieldValidator5" runat="server" ErrorMessage="<br /Genre is Required" 
        ...
        <InsertItemTemplate>
            <tr class="">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator CssClass="text-warning" ID="RequiredFieldValidator8" runat="server" ErrorMessage="<br />Status is Required" 
                        ControlToValidate="status_idTextBox" Display="Dynamic" ValidationGroup="Insert"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ControlToValidate="status_idTextBox" ID="RangeValidator3" runat="server" ErrorMessage="<br />Status must be 1 or 2" Type="Integer" ValidationGroup="Insert"
                           CssClass="text-warning" Display="dynamic" MaximumValue="2" MinimumValue="1"></asp:RangeValidator>
                </td>
                <td>
                    <asp:TextBox ID="disk_type_idTextBox" runat="server" Text='<%# Bind("disk_type_id") %>' ValidationGroup="Insert"/>
                    <asp:RequiredFieldValidator CssClass="text-warning" ID="RequiredFieldValidator9" runat="server" ErrorMessage="<br />Type is Required" 
                        ControlToValidate="disk_type_idTextBox" Display="Dynamic" ValidationGroup="Insert"></asp:RequiredFieldValidator>
                    <asp:RangeValidator ControlToValidate="disk_type_idTextBox" ID="RangeValidator4" runat="server" ErrorMessage="<br />Type must be 1 or 2" Type="Integer" ValidationGroup="Insert"
                           CssClass="text-warning" Display="dynamic" MaximumValue="2" MinimumValue="1"></asp:RangeValidator>
                </td>
                <td>
                    <asp:TextBox ID="genre_idTextBox" runat="server" Text='<%# Bind("genre_id") %>' ValidationGroup="Insert"/>
                    <asp:RequiredFieldValidator CssClass="text-warning" ID="RequiredFieldValidator10" runat="server" ErrorMessage="<br />Genre is Required" 
